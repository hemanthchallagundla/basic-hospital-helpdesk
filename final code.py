#importing the tkinter module for the GRAPHICAL USER INTERFACE
from tkinter import * 
#creating the main window
root=Tk()


#declaring a function for creating a new window and display information
def doctor():
    #creating a window which depends on the main window
    doctorwindow =Toplevel(root)
    #declaring the size of the window
    doctorwindow.geometry('500x300')
    #declaring the tittle of the window
    doctorwindow.title("doctor info")
    #importing icon for the window
    doctorwindow.iconbitmap(r'C:\Users\heman\Downloads\qiBXx4AaT.ico')
    #creating the exit button for this window
    de = Button(doctorwindow,text="Exit",bd=5,command=doctorwindow.destroy,activeforeground='red')
    #declaring the font for text on the button
    de.config(font=("Borealis",15))
    #creating a button to open other window
    ddw=Button(doctorwindow,text="doctor details",bd=10,activeforeground='blue4',command=docdetail)
    #organising the button position
    ddw.pack()
    #creating a button to open other window
...
#declaring a function for creating a new window and display information
def docdetail():    
    #creating a window which depends on the parent window
    ...
    #displaying information in the form of table
    for i in range(10):#for rows
        for j in range(4):#for coloumns
            if i==0:
    ...
    ddwe.grid(row=11,column=2,sticky=W,pady=10)
...
def precautions():
    ...
    pe.grid(row=11,column=2,sticky=W,pady=10)  
...
def lab():
    ...
    #creating a button to close the present window
...
def labfee():
    ...
    lfe.grid(row=24,column=1,sticky=W,pady=10)
...
def labtest():
    ...
    lte.grid(row=24,column=1,sticky=W,pady=10)           



#declaring the title for the main window
...
be=Button(root,text="EXIT",bd=5,command=root.destroy,activeforeground='red')
 #creating a button to open other window
bp=Button(root,text="safety precautions",bd=10,command=precautions,activeforeground='yellow')
 #creating a button to open other window
...
#organizing the buttons and labels
ld.pack()
bdi.pack()
bp.pack()
bl.pack()
...
#giving the information which is to be displayed as a table
...
#command for the continous loop
root.mainloop()